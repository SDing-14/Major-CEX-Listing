"""
Bithumb listing processor - reads raw scrape data and formats it into clean output
...
class BithumbProcessor:
    """Process raw Bithumb scrape data into clean listing format"""
    ...
    def process_file(self, input_file):
        """Process raw Bithumb scrape JSON file"""
...
def main():
    """Main function to process Bithumb scrape results"""
    import sys
    
    processor = BithumbProcessor()
    
    # Default input file
    input_file = 'bithumb_listings.json'
    ...
    if listings:
        ...
        processor.save_to_json(listings, f'bithumb_processed_{timestamp}.json')
        processor.save_to_csv(listings, f'bithumb_processed_{timestamp}.csv')
