"""
OKX listing processor - reads raw scrape data and formats it into clean output
...
class OKXProcessor:
    """Process raw OKX scrape data into clean listing format"""
    ...
    def process_file(self, input_file):
        """Process raw OKX scrape JSON file"""
...
def main():
    """Main function to process OKX scrape results"""
    import sys
    
    processor = OKXProcessor()
    
    # Default input file
    input_file = 'okx_listings.json'
    ...
    if listings:
        ...
        processor.save_to_json(listings, f'okx_processed_{timestamp}.json')
        processor.save_to_csv(listings, f'okx_processed_{timestamp}.csv')
