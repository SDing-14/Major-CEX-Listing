"""
Upbit exchange scraper - scrapes listing data from ListedOn.org
"""
...
class UpbitScraper:
    """Scraper for Upbit exchange listings via ListedOn.org"""
    
    def __init__(self, headless=True):
        self.headless = headless
        self.driver = None
        self.exchange_name = "Upbit"
        self.url = "https://listedon.org/en/exchange/upbit"
    ...
    def scrape(self, max_pages=1):
        """
        Scrape Upbit listings from ListedOn.org
...
def main():
    """Test the Upbit scraper"""
    print("="*80)
    print("UPBIT SCRAPER TEST (via ListedOn.org)")
    print("="*80 + "\n")
    
    scraper = UpbitScraper(headless=False)  # Set to True to hide browser
