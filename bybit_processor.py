"""
Bybit listing processor - reads raw scrape data and formats it into clean output
...
class BybitProcessor:
    """Process raw Bybit scrape data into clean listing format"""
    ...
    def process_file(self, input_file):
        """Process raw Bybit scrape JSON file"""
...
def main():
    """Main function to process Bybit scrape results"""
    import sys
    
    processor = BybitProcessor()
    
    # Default input file
    input_file = 'bybit_listings.json'
    ...
    if listings:
        ...
        processor.save_to_json(listings, f'bybit_processed_{timestamp}.json')
        processor.save_to_csv(listings, f'bybit_processed_{timestamp}.csv')
