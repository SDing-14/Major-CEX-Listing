"""
OKX exchange scraper - scrapes listing data from ListedOn.org
"""
...
class OKXScraper:
    """Scraper for OKX exchange listings via ListedOn.org"""
    
    def __init__(self, headless=True):
        self.headless = headless
        self.driver = None
        self.exchange_name = "OKX"
        self.url = "https://listedon.org/en/exchange/okex"
    ...
    def scrape(self, max_pages=1):
        """
        Scrape OKX listings from ListedOn.org
...
def main():
    """Test the OKX scraper"""
    print("="*80)
    print("OKX SCRAPER TEST (via ListedOn.org)")
    print("="*80 + "\n")
    
    scraper = OKXScraper(headless=False)  # Set to True to hide browser
