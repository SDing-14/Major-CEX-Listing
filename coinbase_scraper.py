"""
Coinbase exchange scraper - scrapes listing data from ListedOn.org
"""
...
class CoinbaseScraper:
    """Scraper for Coinbase exchange listings via ListedOn.org"""
    
    def __init__(self, headless=True):
        self.headless = headless
        self.driver = None
        self.exchange_name = "Coinbase"
        self.url = "https://listedon.org/en/exchange/gdax"
    ...
    def scrape(self, max_pages=1):
        """
        Scrape Coinbase listings from ListedOn.org
...
def main():
    ...
    print("="*80)
    print("COINBASE SCRAPER TEST (via ListedOn.org)")
    print("="*80 + "\n")
    
    scraper = CoinbaseScraper(headless=False)  # Set to True to hide browser
